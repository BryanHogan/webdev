...
/* Color */
    ...
    /* Consider defining on what a color is used on, like "--color-heading: var(--color-neutral-100)"*/
...
Select colors as described on [this page](/visual-design/colors). Define them to reuse them when needed. This way we have a coherent design. And if needed we can change the colors at one place, this can be usuful when we want to have different color themes such as light and dark mode.
