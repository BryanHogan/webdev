...
/* Other */
    ...
    --text-max-width: min(75ch, var(--max-width-smart-container));
...
Define spacing sizes. We want to keep reusing these values. Elements of the same group will be placed closer together, while items of different groups have larger spacing. By defining values we can achieve a design that looks much cleaner and does not look for feel arnotrary.  
...
- navbar height, footer height, opacity
