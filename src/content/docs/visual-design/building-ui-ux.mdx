...
<CardGrid>
    ...
    <LinkCard
        ...
        description="The NNGroup creates good content on UX design and usability."
        target="_blank"
    />
    <LinkCard
    ...
    />
    <LinkCard
        title="Design System accessibility guidelines of the GOV.UK site"
...
- Short list of useful sites on design found in the (unfinished) MDN docs guide: https://developer.mozilla.org/en-US/docs/Learn_web_development/Core/Design_for_developers#see_also
