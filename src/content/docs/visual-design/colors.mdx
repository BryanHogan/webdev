...
Stay simple and keep it light with your colors in the beginning. It's always possible to add more colors later.
...
One way to find colors that compliment each other is by using **color wheels**. Here you can choose what kind of harmony of colors you want and then get some recommendations.
...
Another way to find complementary  colors is by using palette generators. I used [coolors.co](https://coolors.co/) and [mycolor.space](https://mycolor.space/) before.
