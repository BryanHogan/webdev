...
This CSS code is included in the Codepen example but you would not put this part into the component itself, instead you want to define these in other CSS files, more in these in [CSS Reset](/css/css-reset) and [CSS Utility Classes](/css/utility-classes).
