...
10. **Include Schema.org markup.** Schema.org structured data provides additional information which search engines can use to provide additional information such as rich results.  
    Can recommend this [writeup on using schema markup](https://neilpatel.com/blog/get-started-using-schema/) for using it for the first time.
    Validate and test with [developers.google.com/search/docs/appearance/structured-data](https://developers.google.com/search/docs/appearance/structured-data).[^1]
    https://technicalseo.com/tools/schema-markup-generator/ is helpful with generating Schema.org structured data.
