...
<CardGrid>
    ...
    <LinkCard
        ...
        description="Ease: Simple | Cost: Free <br/> Very simple but also quite limited."
        target="_blank"
    />
    <LinkCard
    ...
    <LinkCard
        ...
        description="Ease: Moderate | Cost: Low <br/> The most popular CMS. It can be simple (using visual plugins) or complex depending on your needs. Great ecosystem, but requires maintenance."
        target="_blank"
    />
</CardGrid>
...
<CardGrid>
    <LinkCard
        ...
        description="Ease: Simple | Cost: Moderate <br/> Publish Notion notes as a website using Notion's official integration."
        target="_blank"
    />
    <LinkCard
        title="Obsidian Publish"
        href="https://obsidian.md/publish"
        description="Ease: Simple | Cost: Moderate <br/> Publish Obsidian notes using the official integration."
        target="_blank"
    />
    <LinkCard
...
<CardGrid>
    <LinkCard
        ...
        description="Ease: Simple | Cost: Low <br/> A privacy-first, no-nonsense blogging platform. No JavaScript, no tracking, just writing."
        target="_blank"
    />
    <LinkCard
        title="Leaflet"
        href="https://leaflet.pub/"
        description="Ease: Simple | Cost: Free <br/> A simple blogging tool built on the Bluesky AT Protocol."
        target="_blank"
    />
</CardGrid>
...
<CardGrid>
    <LinkCard
        ...
        description="Ease: Moderate | Cost: High <br/> Create websites using Figma like interface."
        target="_blank"
    />
    <LinkCard
        title="Framer"
    ...
    <LinkCard
        ...
        description="Ease: Moderate | Cost: High <br/> A drag-and-drop builder that works with code-based frameworks for more flexibility."
        target="_blank"
    />
    <LinkCard
        title="WebStudio"
        href="https://webstudio.is/"
        description="Ease: Moderate | Cost: Low <br/> An open-source visual builder that offers a free self-hosted option."
        target="_blank"
    />
    <LinkCard
        title="Figma Sites"
        href="https://www.figma.com/sites/"
        description="Ease: Moderate | Cost: High <br/> Takes designs in Figma, the visual design tool, to create a website."
        target="_blank"
    />
</CardGrid>
