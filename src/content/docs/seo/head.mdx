...
- **Favicon**. The icon of your webpage. There's a [guide by EvilMartians](https://evilmartians.com/chronicles/how-to-favicon-in-2021-six-files-that-fit-most-needs) on how to optimize your favicon for legacy browsers but just using a simple svg is also okay for most use cases.
...
<html lang="en">
  <head>
    ...
    <meta property="og:title" content="Blog Title, 30 - 60 characters" />
    <meta property="og:description" content="Description which should be between 50 - 160 characters." />
