...
<Aside>
My most modern implementation of this in an Astro project that uses CSS variables can be found on [this repository here](https://github.com/BryanHogan/bryanhogan/blob/main/src/styles/markdown.css).
...
- Plans for the future of this page: Update it and provide code example of with as implemented on [here](https://github.com/BryanHogan/bryanhogan/blob/main/src/styles/markdown.css) and without CSS variables.
